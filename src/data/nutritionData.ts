export const breakfast = [
  ...
  { label: 'Сereals', value: 'Сereals' },
  { label: 'Сottage cheese', value: 'Сottage cheese' },
  { label: 'Toast', value: 'Toast' },
  { label: 'Toast', value: 'Toast' },
];

export const lunch = [{ label: 'Buckwheat', value: 'Buckwheat' },
{ label: 'Rice', value: 'Rice' },
{ label: 'Pasta', value: 'Pasta' }, { label: 'Chicken', value: 'Chicken' },
{ label: 'Pork', value: 'Pork' },
{ label: 'Beef', value: 'Beef' }, { label: 'Nuts', value: 'Nuts' },
...
export const cuisineType = [
  ...
  { label: 'South Eastern Asian', value: 'South Eastern Asian' },
];
