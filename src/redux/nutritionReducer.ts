...
import { NutritionFormValues } from '../components/Nutrition/NutritionForm/NutritionForm';
...
export const getRecipes = (data: NutritionFormValues, type: string, calories: number,): ThunkAction<void, RootState, unknown, AnyAction> =>
  async (dispatch) => {
    if (type === 'Breakfast') {
